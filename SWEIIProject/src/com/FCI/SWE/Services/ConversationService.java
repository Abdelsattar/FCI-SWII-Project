 ...
 * @param sender , rec_name1 , rec_name2 , rec_name3 , Message
...
public class ConversationService {
	...
	,@FormParam("recName3") String rec_name3,@FormParam("Mesg") String Message) {
        ...
        if (  userEntity==null&&(userEntity1==null||userEntity2==null||userEntity3==null)) {
			...
			json.put("Status", "OK");
			MessageObserver obj1= new MessageObserver(userEntity1.getId(),rec_name1);
			MessageObserver obj2= new MessageObserver(userEntity2.getId(),rec_name2);
			MessageObserver obj3= new MessageObserver(userEntity3.getId(),rec_name3);
